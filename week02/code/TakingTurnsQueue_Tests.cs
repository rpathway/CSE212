...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People with one remaining turn were removed before completing the final turn
    ...
    // Defect(s) Found: The queue removed players before their turns were completed
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Players with 0 turns weren't treated as having infinite turns and were removed
    ...
    // Defect(s) Found: Players with negative turns weren't treated as having infinite turns
